...
import { regexForEmail, regexForName, regexForUser } from "../../constants/constantVariables";
...
export default function RegisterUser() {
	...
	const success = (data: string) => toast.success(data, { position: toast.POSITION.BOTTOM_RIGHT });
				...
				<Form onSubmit={(e) => addtenant(e)} className="p-4">
					...
					<Form.Group className="mb-3">
						...
						{tenant.userid && !regexForUser.test(tenant.userid) && (
							<span className="text-danger">Id Should Contain alphabet, number.(i.e. : paras123, p_A_r_A_s_1)</span>
						)}
					</Form.Group>
					<Form.Group className="mb-3">
					...
					<Form.Group className="mb-3">
						...
						<Form.Control type="text" value="Password Will Be Auto Genrated " disabled />
					</Form.Group>
